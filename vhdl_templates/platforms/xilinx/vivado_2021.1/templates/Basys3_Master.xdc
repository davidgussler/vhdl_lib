...
## Clock signal
# Period = freq in mhz / 1000 -> eg 10 = 1000 / 100MHz
...
#set_property PACKAGE_PIN U19 [get_ports {on_led}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {on_led}]
...
##Pmod Header JC
##Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {db_rx}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {db_rx}]
##Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {db_tx}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {db_tx}]
##Sch name = JC3
...
##USB-RS232 Interface
#set_property PACKAGE_PIN B18 [get_ports i_uart]						
#	set_property IOSTANDARD LVCMOS33 [get_ports i_uart]
#set_property PACKAGE_PIN A18 [get_ports o_uart]						
